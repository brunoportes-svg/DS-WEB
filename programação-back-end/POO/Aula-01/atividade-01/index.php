...
$armariodecozinha = new armario();//colocar cada tipo de armario, colocar um atributo e chamar o método correspondente a esse atributo
...
echo "<br>";
$mesadobruno = new mesa();
$mesadobruno->textura = "lisa";
echo $mesadobruno->subir();
...
echo "<br>";
$cadeiradobruno = new cadeira();
$cadeiradobruno->mateiral = "madeira";
echo $cadeiradobruno->subir();
echo "<br>";
echo "<hr/>";
